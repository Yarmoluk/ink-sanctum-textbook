...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Glossary | :white_check_mark: | Medium | 198 terms with ISO 11179 compliant definitions |
| FAQ page | :white_check_mark: | Medium | 66 answers to common student questions |
| References page | :x: | Medium | Curated bibliography with links per chapter or site-wide |
| Custom CSS styling | :x: | Low | Override theme colors, fonts, and layouts |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :x: | High | 0 browser-based apps for hands-on learning |
...
| Learning graph viewer (vis-network) | :x: | Medium | Interactive diagram where you can click and explore concepts |
